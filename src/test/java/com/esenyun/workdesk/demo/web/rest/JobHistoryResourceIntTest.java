...
import com.esenyun.workdesk.demo.repository.JobHistoryRepository;
import com.esenyun.workdesk.demo.service.JobHistoryService;
import com.esenyun.workdesk.demo.repository.search.JobHistorySearchRepository;
import com.esenyun.workdesk.demo.service.dto.JobHistoryDTO;
import com.esenyun.workdesk.demo.service.mapper.JobHistoryMapper;
...
import static com.esenyun.workdesk.demo.web.rest.TestUtil.createFormattingConversionService;
...
import com.esenyun.workdesk.demo.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIntTest {
     ...
     *
     * @see com.esenyun.workdesk.demo.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
