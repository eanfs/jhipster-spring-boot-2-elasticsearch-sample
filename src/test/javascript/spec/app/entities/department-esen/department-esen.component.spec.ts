...
import { DepartmentEsenComponent } from 'app/entities/department-esen/department-esen.component';
...
describe('Component Tests', () => {
    describe('DepartmentEsen Management Component', () => {
        let comp: DepartmentEsenComponent;
        let fixture: ComponentFixture<DepartmentEsenComponent>;
        let service: DepartmentEsenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Jhipster5TestModule],
                declarations: [DepartmentEsenComponent],
                providers: [
                ...
                .overrideTemplate(DepartmentEsenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(DepartmentEsenComponent);
