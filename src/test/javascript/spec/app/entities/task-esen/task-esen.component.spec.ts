...
import { TaskEsenComponent } from 'app/entities/task-esen/task-esen.component';
...
describe('Component Tests', () => {
    describe('TaskEsen Management Component', () => {
        let comp: TaskEsenComponent;
        let fixture: ComponentFixture<TaskEsenComponent>;
        let service: TaskEsenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Jhipster5TestModule],
                declarations: [TaskEsenComponent],
                providers: [
                    TaskEsenService,
                    {
                ...
                .overrideTemplate(TaskEsenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(TaskEsenComponent);
