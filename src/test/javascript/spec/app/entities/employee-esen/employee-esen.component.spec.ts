...
import { EmployeeEsenComponent } from 'app/entities/employee-esen/employee-esen.component';
...
describe('Component Tests', () => {
    describe('EmployeeEsen Management Component', () => {
        let comp: EmployeeEsenComponent;
        let fixture: ComponentFixture<EmployeeEsenComponent>;
        let service: EmployeeEsenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Jhipster5TestModule],
                declarations: [EmployeeEsenComponent],
                providers: [
                    EmployeeEsenService,
                    {
                ...
                .overrideTemplate(EmployeeEsenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(EmployeeEsenComponent);
