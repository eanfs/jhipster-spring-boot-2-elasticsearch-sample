...
import { CountryEsenComponent } from 'app/entities/country-esen/country-esen.component';
...
describe('Component Tests', () => {
    describe('CountryEsen Management Component', () => {
        let comp: CountryEsenComponent;
        let fixture: ComponentFixture<CountryEsenComponent>;
        let service: CountryEsenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Jhipster5TestModule],
                declarations: [CountryEsenComponent],
                providers: [
                    CountryEsenService,
                    {
                ...
                .overrideTemplate(CountryEsenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CountryEsenComponent);
