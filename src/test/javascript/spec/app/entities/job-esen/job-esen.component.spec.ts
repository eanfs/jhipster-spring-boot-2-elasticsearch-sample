...
import { JobEsenComponent } from 'app/entities/job-esen/job-esen.component';
import { JobEsenService } from 'app/entities/job-esen/job-esen.service';
import { JobEsen } from 'app/shared/model/job-esen.model';

describe('Component Tests', () => {
    describe('JobEsen Management Component', () => {
        let comp: JobEsenComponent;
        let fixture: ComponentFixture<JobEsenComponent>;
        let service: JobEsenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Jhipster5TestModule],
                declarations: [JobEsenComponent],
                providers: [
                    JobEsenService,
                    {
                ...
                .overrideTemplate(JobEsenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(JobEsenComponent);
