...
import { RegionEsenComponent } from 'app/entities/region-esen/region-esen.component';
...
describe('Component Tests', () => {
    describe('RegionEsen Management Component', () => {
        let comp: RegionEsenComponent;
        let fixture: ComponentFixture<RegionEsenComponent>;
        let service: RegionEsenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [Jhipster5TestModule],
                declarations: [RegionEsenComponent],
                providers: [
                    RegionEsenService,
                    {
                ...
                .overrideTemplate(RegionEsenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(RegionEsenComponent);
