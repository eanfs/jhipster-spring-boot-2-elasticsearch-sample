...
@Component({
    selector: 'jhi-job-history-esen',
    templateUrl: './job-history-esen.component.html'
})
export class JobHistoryEsenComponent implements OnInit, OnDestroy {
    jobHistories: IJobHistoryEsen[];
    currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.jobHistoryService
                ...
                .subscribe(
                    (res: HttpResponse<IJobHistoryEsen[]>) => this.paginateJobHistories(res.body, res.headers),
    ...
    trackId(index: number, item: IJobHistoryEsen) {
        return item.id;
    }
    ...
    private paginateJobHistories(data: IJobHistoryEsen[], headers: HttpHeaders) {
