...
@Component({
    selector: 'jhi-country-esen',
    templateUrl: './country-esen.component.html'
})
export class CountryEsenComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.countryService
                ...
                .subscribe(
                    (res: HttpResponse<ICountryEsen[]>) => this.paginateCountries(res.body, res.headers),
    ...
    trackId(index: number, item: ICountryEsen) {
        return item.id;
    }
    ...
    private paginateCountries(data: ICountryEsen[], headers: HttpHeaders) {
