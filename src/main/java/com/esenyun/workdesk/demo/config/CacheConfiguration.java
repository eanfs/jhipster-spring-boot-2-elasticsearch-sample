package com.esenyun.workdesk.demo.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipster5");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipster5");
        ...
        config.getMapConfigs().put("com.esenyun.workdesk.demo.domain.*", initializeDomainMapConfig(jHipsterProperties));
